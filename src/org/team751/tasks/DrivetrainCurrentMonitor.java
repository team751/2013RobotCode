...
public class DrivetrainCurrentMonitor {
	 ...
	 */
	/*
	 * Because this is accessed both from the main robot thread and from the
	 * timer
	 * thread, it must always be accessed within a synchronized(currentValues){}
	 * block.
	 */
	private final FixedCapacityDoubleQueue currentValues = new FixedCapacityDoubleQueue(
			10);
