...
/**
 * A command that calculates motion profiling and drives the robot
 * to follow the path that it calculates over time. This command can be used
 * for both moving and rotation. Subclasses can specialize to do either
 * movement or rotation alone.
 * @author Sam Crow
 */
